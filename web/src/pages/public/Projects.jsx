                          ...
                          <div key={year} className="space-y-1">
                            <button
                              ...
                              className={`w-full flex items-center justify-between p-3 rounded-2xl transition-all duration-200 ${
                                expandedYears[year] ? 'bg-violet-50 text-violet-700' : 'hover:bg-slate-50 text-slate-700'
                              }`}
                            >
                              <div className="flex items-center gap-3">
                                <div className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${
                                  expandedYears[year] ? 'bg-violet-500 text-white shadow-lg shadow-violet-200' : 'bg-slate-100 text-slate-500'
                                }`}>
                                  <Folder size={16} />
                                </div>
                                    ...
                                    <div key={`${year}-${month}`} className="space-y-1">
                                      <button
                                        ...
                                        className={`w-full flex items-center justify-between p-2 rounded-xl transition-all ${
                                          expandedMonths[`${year}-${month}`] ? 'text-violet-600 bg-violet-50/50' : 'text-slate-600 hover:bg-slate-50'
                                        }`}
                                      >
