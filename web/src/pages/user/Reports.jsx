...
//               {/* Modal content */}
//               <div
//                 className="bg-white w-full h-full sm:h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col"
...
//                 </div> */}
//                 {selectedReport.isAnonymous && (
//                   <p className="text-xs text-red-500 mb-2 sm:mb-0 sm:mr-auto">
//                     ⚠ This action is permanent. You can only edit limited fields after disclosure.
//                   </p>
//                 )}
...
//                       className="px-4 sm:px-6 py-2 bg-purple-600 text-white rounded-lg
//     hover:bg-purple-700 active:bg-purple-800
//     disabled:opacity-50 disabled:cursor-not-allowed
//     transition-colors font-medium text-sm sm:text-base w-full sm:w-auto"
//                     >
//                       {loading ? "Processing..." : "Disclose Identity"}
//                     </button>
...
export default function Reports() {
  ...
  // const handleReveal = async (reportId) => {
  //   // Prompt for password
  //   const password = prompt("Enter your password to disclose your identity:");
  //   if (!password) return alert("Password is required.");
