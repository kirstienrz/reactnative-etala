...
const NotificationCenter = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 md:w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 z-[10000] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div>
              ...
              {unreadCount > 0 && (
                <button 
                  ...
                  className="text-[10px] font-bold text-purple-600 hover:underline mt-0.5"
                >
                  Mark all as read
                </button>
              )}
            ...
            {loading && notifications.length === 0 ? (
              ...
              <div className="divide-y divide-gray-50">
                {notifications.map((notification) => (
                   ...
                   >
                     <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${getIconColor(notification.type, notification.isRead)}`}>
                     ...
                     {!notification.isRead && (
                       <div className="w-2 h-2 rounded-full bg-purple-600 self-center"></div>
                     )}
