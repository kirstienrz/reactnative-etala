...
export default function DocumentationAdmin() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-3 pb-24 md:p-6 lg:p-8 relative">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="md:hidden mb-6 space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3.5 bg-white border-none rounded-2xl focus:ring-2 focus:ring-blue-500 font-semibold text-sm shadow-sm"
                        />
                    </div>
                    ...
                    <div className="flex bg-gray-200/60 p-1 rounded-xl">
                        <button
                            ...
                            className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${!viewArchived ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Active
                        </button>
                        <button
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                    {/* Header Actions */}
                    <div className="hidden md:flex px-6 py-5 border-b border-gray-100 items-center justify-between bg-gray-50/30">
                            ...
                            {filteredDocs.length > 0 ? (
                                        ...
                                        {filteredDocs.map(doc => {
                                            ...
                                            return (
                                                <div key={doc._id || doc.id} className="transition-all">
                                                    {/* Document Header */}
                                                    <div
                                                        className={`p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer hover:bg-gray-50/80 transition-all border-l-4 ${isExpanded ? 'border-blue-500 bg-blue-50/5' : 'border-transparent'}`}
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center justify-end w-full sm:w-auto gap-4 sm:gap-6 pt-2 sm:pt-0 border-t sm:border-0 border-gray-100 mt-2 sm:mt-0">
                                ...
                                <div className="p-20 text-center bg-white">
                                    ...
                                    {!viewArchived && !searchQuery && (
                                        <button
                                            onClick={() => setShowCreateModal(true)}
                                            className="mt-8 px-6 py-3 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20"
                                        >
