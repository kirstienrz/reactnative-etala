...
// import { 
//   BookOpen, Video, Search, Filter, Calendar, Award, ExternalLink, Download, PlayCircle 
// } from "lucide-react";
...
//   const categories = ["all", "Economic", "Protection", "Governance", "Education"];

//   const knowledgeBase = [
//     {
//       id: 1,
//       title: "Women's Leadership in Local Governance",
//       speaker: "Dr. Maria Santos",
//       organization: "Philippine Commission on Women",
//       date: "2024-10-15",
//       duration: "2 hours",
//       type: "Webinar",
//       videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
//       description: "Empowering women to lead and influence in local government positions.",
//       tags: ["Leadership", "Governance", "Women Empowerment"]
//     },
//     {
//       id: 2,
//       title: "Gender-Responsive Budgeting Workshop",
//       speaker: "Atty. Juan Dela Cruz",
//       organization: "Department of Budget and Management",
//       date: "2024-09-20",
//       duration: "3 hours",
//       type: "Training",
//       videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
//       description: "Learn to effectively integrate gender perspectives in budget planning.",
//       tags: ["Budget", "Planning", "GAD"]
//     },
//   ];

//   const resources = [
//     { id: 1, title: "RA 9710 - Magna Carta of Women", type: "Legal", size: "2.4 MB", date: "2024-01-15" },
//     { id: 2, title: "GAD Budget Code Guidelines 2024", type: "Policy", size: "1.8 MB", date: "2024-02-20" },
//     { id: 3, title: "Gender Analysis Framework", type: "Tool", size: "3.2 MB", date: "2024-03-10" },
//   ];
...
//         <h1 className="text-3xl font-bold text-gray-900 mb-2">GAD Knowledge Hub</h1>
//         <p className="text-gray-600 text-lg">
//           Discover resources, trainings, and webinars on Gender and Development
//         </p>
//       </div>

//       {/* Search and Filter */}
//       <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mb-8">
//         <div className="flex items-center w-full sm:w-1/2 border rounded-lg px-3 py-2 bg-white shadow-sm">
//           <Search className="text-gray-400 mr-2" size={18} />
//           <input
//             type="text"
//             placeholder="Search topics, speakers, or tags..."
...
//             <div key={item.id} className="border bg-white rounded-lg shadow-sm hover:shadow-md transition">
...
//           <h2 className="text-2xl font-semibold text-gray-900">Resource Library</h2>
//         </div>
...
//                   <td className="p-3 text-gray-600">{res.type}</td>
//                   <td className="p-3 text-gray-600">{res.date}</td>
//                   <td className="p-3 text-gray-600">{res.size}</td>
//                   <td className="p-3 text-center">
//                     <button className="flex items-center mx-auto gap-1 text-blue-600 hover:underline">
...
// // import React, { useState } from "react";
// // import {
// //   Plus, Edit2, Trash2, Video, BookOpen, Search, Filter, Calendar, X
// // } from "lucide-react";
...
// //       type: "Training",
// //       videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
// //       description: "Integrating gender in budget planning.",
// //       tags: ["Budget", "Planning", "GAD"]
// //     }
// //   ]);
...
// //         prev.map((item) =>
// //           item.id === editItem.id
// //             ? { ...formData, id: item.id, tags: formData.tags.split(",").map((t) => t.trim()) }
// //             : item
// //         )
// //       );
// //     } else {
...
// //         <div>
// //           <h1 className="text-3xl font-bold text-gray-900 mb-1">Knowledge Hub Admin</h1>
// //           <p className="text-gray-600">Manage all Gender and Development materials</p>
// //         </div>
// //         <button
// //           onClick={() => openModal()}
...
// //         >
// //           <Video className="inline mr-1" size={16} /> Knowledge Base
// //         </button>
// //         <button
// //           className={`px-4 py-2 font-medium ${
// //             activeTab === "resources"
...
// //         >
// //           <BookOpen className="inline mr-1" size={16} /> Resources
// //         </button>
// //       </div>

// //       {/* Search */}
// //       <div className="flex items-center mb-4 border rounded-lg px-3 py-2 w-full sm:w-1/2 bg-white shadow-sm">
// //         <Search className="text-gray-400 mr-2" size={18} />
// //         <input
// //           type="text"
...
// //                       }
// //                       className="flex items-center mx-auto gap-1 text-red-600 hover:underline"
// //                     >
// //                       <Trash2 size={16} /> Delete
// //                     </button>
// //                   </td>
...
// //               <input
// //                 name="type"
// //                 placeholder="Type (e.g. Training, Webinar)"
// //                 value={formData.type}
// //                 onChange={handleInputChange}
// //                 className="w-full border rounded-lg px-3 py-2"
// //               />
